...
public class Signup_men_console extends Test_Base {
	...
	public void extractJSLogsInfo() throws EmailException
	{
	 ...
	 System.out.println(test);
	   ...
	   Email email = new SimpleEmail();
		...
		email.setSubject("Sign up for men - Console Error");
	...
	public void signup_men_console_error() throws Exception
	{
	  extentTest = extent.startTest("Signup_men_Console");
	  
	    System.out.println("*************SelfieStyler: Sign up for Men - SelfieStyler******************\n");
